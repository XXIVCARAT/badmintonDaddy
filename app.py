...
# --- HELPERS FOR HTMX (SEPARATED) ---

# 1. Only returns the Like Button HTML
def get_likes_html():
...
def index():
      ...
      <body>
                ...
                <div class="tab-pane fade" id="announcements">
                    <div class="container" style="max-width: 700px;">
                        ...
                        <div class="card wish-card p-4 mb-4">
                            ...
                            <div class="d-inline-block mb-4" hx-get="/update-likes" hx-trigger="every 2s" hx-swap="innerHTML">
                                {{ like_html|safe }}
                            </div>
                            ...
                            <div class="text-start">
                                ...
                                <form hx-post="/comment" hx-target="#comments-list" hx-swap="outerHTML" 
        ...
        <script>
            ...
            function updateDisplay() {
                ...
                if (scoreA === 30) winner = 'A'; if (scoreB === 30) winner = 'B';
            ...
            function resetScore() {
                if(confirm("Start a new game?")) { scoreA = 0; scoreB = 0; historyStack = []; updateDisplay(); }
            }
            function swapSides() {
    ...
    # We pass the separate components to the template
    return render_template_string(html_content, 
                                rankings=standings_data, 
                                gif_url=gif_url, 
...
# Route to update ONLY the like button (Separate from comments)
@app.route('/update-likes')
def update_likes(): return get_likes_html()

# Route to update ONLY the comments list
@app.route('/update-comments')
def update_comments(): return get_comments_html()
